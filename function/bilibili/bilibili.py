...
df=pd.read_csv('/Users/zhanghanwen/Desktop/ABtest.csv')
...
X = df.drop(['User_id','Is_purchased_member','new_group','group','User_os',
             'Favorited_songs_type','Is_download','Is_confirm','Is_exclusive_music'
             ,'Is_vip_music_quality'
             ], axis=1)
